...
Market-first investment decision assistant with a fixed 6-stock watchlist.
...
- Scores 6 predefined watchlist stocks with the same daily timestamp.
...
1. Edit `config/watchlist.yml` with exactly 6 tickers.
