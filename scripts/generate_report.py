...
11. 단기투자 팁은 반드시 한 줄의 완전한 문장으로 채운다. 어떤 상황에서도 초단기 기준의 대응 방향을 분명히 제시하고, 지금 매수/추격/대기/비중축소/손절관리 중 무엇이 맞는지 이유를 붙여 짧고 명확하게 쓴다. 보유 중이라고 가정하고 짧은 탈출 전략도 함께 언급한다. `대기` 같은 한 단어만 쓰지 않는다.
